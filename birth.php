...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
	  ...
	  <li>&#187;</li>
      <li>Request Birth Certificate</li>
...
<td style="padding-left:100">Parents ID :         <input type="file"  name="parid" ></td>

</tr>

<tr>
<td style="padding-left:100">Birth Letter :      <input type="file"  name="birthletter"></td>
</tr>

<tr>
<td style="padding-left:100">Marriage Ceritificate(parents) :<input type="file" name="mrgcert" ></td>
</tr>
